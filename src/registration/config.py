...
FRONTAL_FEATURE_RATIO_MIN = 0.0
FRONTAL_FEATURE_RATIO_MAX = 1.0
MODEL_DEVICE = 'cuda' if torch.cuda.is_available() else ('mps' if hasattr(torch.backends, "mps") and torch.backends.mps.is_available() else 'cpu')
